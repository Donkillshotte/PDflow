...
- Extraction and EM live in Python (`pdn_extract`, `pdn_em`): tech LEF WIDTH/THICKNESS/RPERSQ; strap width from \(w=\mathrm{RPERSQ}\cdot L/R\), not min WIDTH. SPEF PG C is not stamped.
