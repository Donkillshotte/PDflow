  ...
  return (
    <main className="overview-page">
      ...
      <section className="home-rail" id="story">
        <ProductStory initial={story} tone="dark" />
      ...
      <section className="home-rail">
        ...
        <p className="footer-note" style={{ marginTop: "0.5rem" }}>
          Four pillars: STA → DRC → LVS → power. Current signoff leftovers
          stay named with their live source path and evidence. ECO close is
          <code>signoff_all</code> on a copy. IR meshes are not
          interchangeable.
        </p>
