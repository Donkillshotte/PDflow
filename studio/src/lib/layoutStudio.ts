...
export const PHASE_GALLERY: Record<LayoutPhaseId, GalleryShot[]> = {
  rtl: [],
  synth: [
    { file: "win_synth.png", title: "ODB synth", caption: "Die 0×0 — netlist, non layout" },
  ],
  floorplan: [
    { file: "03_pdn.png", title: "Die + PDN", caption: "Straps VDD/VSS sul floorplan" },
    { file: "win_floorplan.png", title: "GUI floorplan", caption: "Finestra OpenROAD" },
    { file: "win_pdn.png", title: "GUI PDN", caption: "Display Control" },
    { file: "win_tapcell.png", title: "Tapcells", caption: "Well taps sulle row" },
    { file: "win_anatomy_labeled.png", title: "Anatomia GUI", caption: "Zone A–G della finestra" },
  ],
  pdn: [
    { file: "03_pdn_labeled.png", title: "PDN labeled", caption: "VDD / VSS annotate" },
    { file: "03_pdn.png", title: "PDN", caption: "Straps metal" },
    { file: "win_pdn.png", title: "GUI PDN", caption: "Finestra OpenROAD" },
  ],
  place: [
    { file: "05_place_dp.png", title: "Detailed place", caption: "Celle legalizzate sulle row" },
    { file: "04_place_gp_labeled.png", title: "Global place", caption: "Prima della legalizzazione" },
    { file: "04_place_gp.png", title: "GP", caption: "Global placement" },
    { file: "win_place_dp.png", title: "GUI DP", caption: "Finestra OpenROAD" },
    { file: "win_place_gp.png", title: "GUI GP", caption: "Finestra global place" },
  ],
  cts: [
    { file: "06_cts.png", title: "Clock tree", caption: "Buffer CTS sul die" },
    { file: "win_cts.png", title: "GUI CTS", caption: "Finestra OpenROAD" },
    { file: "orfs_cts_clock_tree.png", title: "Clock diagram", caption: "Report ORFS" },
    { file: "win_clock_filter.png", title: "Clock nets", caption: "Filtro Display Control" },
    { file: "orfs_cts_clock_layout.png", title: "Clock layout", caption: "Heatmap clock" },
  ],
  route: [
    { file: "08_route_labeled.png", title: "DRT labeled", caption: "M2 rosso · M3 verde" },
    { file: "07_grt.png", title: "Global route", caption: "Guide GRT (non metal finale)" },
    { file: "win_layers_m2m3.png", title: "Solo M2/M3", caption: "Display Control isolato" },
    { file: "win_grt.png", title: "GUI GRT", caption: "Congestione globale" },
    { file: "win_route.png", title: "GUI DRT", caption: "Finestra detailed route" },
    { file: "orfs_final_congestion.png", title: "Congestione", caption: "Heatmap ORFS" },
  ],
  finish: [
    { file: "09_final.png", title: "Final GDS", caption: "Vista signoff" },
    { file: "win_final.png", title: "GUI final", caption: "Finestra OpenROAD" },
    { file: "orfs_final_worst_path.png", title: "Worst path", caption: "Timing path" },
    { file: "orfs_final_clocks.png", title: "Clocks", caption: "Reti di clock" },
    { file: "orfs_final_congestion.png", title: "Congestione", caption: "Heatmap" },
  ],
  pkg: [
    { file: "orfs_final_ir_drop.png", title: "IR drop", caption: "Heatmap post-finish" },
    { file: "09_final.png", title: "Final GDS", caption: "Layout completo" },
...
export const PHASE_LAYERS: Partial<Record<LayoutPhaseId, LayerSwatch[]>> = {
  floorplan: [
    { id: "die", name: "Die", color: "#6e7681", role: "Outline del chip" },
  ...
  pdn: [
    { id: "m1", name: "Metal1", color: "#4b8bff", role: "Followpin sulle row" },
    { id: "m4", name: "Metal4", color: "#c8d44a", role: "Strap PDN verticali" },
    { id: "m7", name: "Metal7", color: "#f0883e", role: "Strap PDN superiori" },
  ],
  place: [
    { id: "cells", name: "Celle", color: "#58a6ff", role: "LEF boxes legalizzati" },
    { id: "rows", name: "Rows", color: "#3d4a5c", role: "Allineamento placement" },
    { id: "m1", name: "Metal1", color: "#4b8bff", role: "Pin + rail, non ancora signal route" },
  ],
  cts: [
    { id: "clk", name: "Clock", color: "#f0883e", role: "Net di clock + buffer" },
    { id: "cells", name: "Celle", color: "#58a6ff", role: "Stdcell + clock inverters" },
  ...
  route: [
    ...
    },
    {
      ...
      name: "Metal3",
      color: "#3ecf4c",
      role: "Signal — verde in GUI",
      soloShot: "win_layers_m2m3.png",
    },
    { id: "pdn", name: "PDN", color: "#e6c84a", role: "Straps potenza" },
  ...
  finish: [
    ...
    { id: "clk", name: "Clock", color: "#f0883e", role: "Reti di clock", soloShot: "orfs_final_clocks.png" },
  ],
  pkg: [
