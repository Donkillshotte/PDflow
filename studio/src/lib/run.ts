...
function resolveCommand(
  ...
  const analysisScripts: Record<string, { script: string; pythonpath?: boolean }> = {
    ...
    ccs_char: { script: "run_ccs_char.sh", pythonpath: true },
    lab_asap7_pdk: { script: "run_lab_asap7_pdk.sh", pythonpath: true },
    lab_asap7_pkg: { script: "run_lab_asap7_pkg.sh", pythonpath: true },
    lab_asap7_chip_pdn: { script: "run_lab_asap7_chip_pdn.sh", pythonpath: true },
    lvs_deep: { script: "run_lvs_deep.sh", pythonpath: true },
