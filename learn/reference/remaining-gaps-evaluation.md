...
| **ECO after finish** | **Closed as propose/apply + signoff_all on a copy** | Done | Apply refused on flowlab. Incremental GRT + detailed_route legalizes size-up. DRT-0206 restore-source remains the fallback. Setup may stay open; leftover is named. Close is `signoff_all`. |
