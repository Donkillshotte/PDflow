...
**Course:** `learn/lessons/07-finish/` · **FlowLab:** [finish](/flow?phase=finish) owns STA · DRC · LVS · chip IR. System PDN and Phase 2 live on [`/pkg`](/pkg).
