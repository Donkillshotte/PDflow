...
| Chip PDN mesh (`write_pg_spice`) | **WORKS*** leftover-named when OpenROAD + mesh patch | `lab_asap7_chip_pdn.json` · tier B | `map::at` on ~9 µm die — BPin V + uniform ITerm I patched · not 45.298 mV |
