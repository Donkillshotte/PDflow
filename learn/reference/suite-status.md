...
| ECO | **WORKS*** | propose on flowlab; apply/close on eco_scratch | Does not skip `signoff_all`. Size-up cannot legalize (DRT-0206); source restored. OpenSTA WNS −0.02 ns |
