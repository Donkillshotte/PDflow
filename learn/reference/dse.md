...
| **pdn** | `c_decap`, pkg L, **pkg_r (static IR)**, I(t)×power, mesh candidato/host, solver MF | ingest gold + extract candidato + **extract host** + **extract host-regione** + DirectLU/AMG/RAS/Krylov + **AMG/RAS/Krylov su winning_ir_pdn** + **pkg_r su winning_static_pdn** (non gold) |
