// Simple RTL testbench for ORFS GCD (PyMTL-derived).
// req_msg = {a[31:16], b[15:0]}; handshake req_val/req_rdy, resp_val/resp_rdy.
`timescale 1ns/1ps
...
module tb_gcd;
  ...
  initial begin
    $dumpfile("learn/sim/gcd/gcd.vcd");
    $dumpvars(0, tb_gcd);
    ...
    if (errors == 0) $display("RTL_SIM_PASS");
    else $display("RTL_SIM_FAIL errors=%0d", errors);
    $finish;
  end
endmodule
