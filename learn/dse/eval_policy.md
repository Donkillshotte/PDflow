...
**Verdict:** I5 supported (place Spearman 0.938 ≥ 0.6; F1 Spearman 0.866)

```json
{
  "n_place_pairs": 85,
  "n_f1_pairs": 3,
  "place_spearman": 0.9377436353791465,
...
**Verdict:** gate FP=46 FN=1 precision=0.207 (13 product-wins among 73 challengers)
...
**Verdict:** QoR vs base: 12 reference slots, 73 challengers, 73 with IR, 73 with GRT WL, 20 product wins
