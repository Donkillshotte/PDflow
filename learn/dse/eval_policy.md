...
**Verdict:** I5 supported (place Spearman 0.942 ≥ 0.6; F1 Spearman 0.866)

```json
{
  "n_place_pairs": 65,
  "n_f1_pairs": 3,
  "place_spearman": 0.9418350470284245,
...
**Verdict:** gate FP=36 FN=1 precision=0.143 (7 product-wins among 53 challengers)
...
**Verdict:** QoR vs base: 12 reference slots, 53 challengers, 53 with IR, 53 with GRT WL, 14 product wins
