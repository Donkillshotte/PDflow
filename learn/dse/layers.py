...
ADAPTERS: dict[str, dict] = {
    ...
    "cell": {
        ...
        "note": "attributed STA path drive-up (module-scoped), I-scale-win IR-hotspot ODB-join, I-scale-champ ODB-join + write_pg_spice residual vs IR-cell extract (re-paid per winning_ir extract), and leftover champ-extract cone size-up + write_pg_spice residual vs IR-cell-champ extract; not ABC ops, not a chip restart",
    },
    "net": {
