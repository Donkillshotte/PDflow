...
def main() -> int:
    ...
    check("leftoverMcmmDetail" in sig_ts, "timing leftover names leftover no MCMM")
    ...
    if live.is_file():
        ...
        if scratch.get("ok"):
            ...
            if close.is_file():
                ...
                check((sig.get("mcmm_leftover") or {}).get("mcmm") is False, "eco close names leftover no MCMM")
