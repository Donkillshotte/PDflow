...
| 4 | Workbook: exercises, quiz, final project | `workbook/{README,quiz,final-project-template,notes-template,solutions}.md` | smoke: files + GUI quiz + project cites golden-metrics |
...
- Having compiled `my-notebook.md` / `my-final-project.md` (student work).
